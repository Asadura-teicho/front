...
function AppContent() {
  ...
  const [currentGame, setCurrentGame] = useState<'sweet-bonanza' | 'gates-of-olympus' | null>(null);
  const { t } = useLanguage();
  ...
  // Slot Game Routing - Show as overlay (check first, before page checks)
  if (currentGame === 'sweet-bonanza') {
    return (
      <SweetBonanzaPage 
        onClose={() => setCurrentGame(null)} 
        onSwitchGame={() => setCurrentGame('gates-of-olympus')}
      />
    );
  }
  ...
  //     <GatesOfOlympusPage 
  //       onClose={() => setCurrentGame(null)} 
  //       onSwitchGame={() => setCurrentGame('sweet-bonanza')}
  //     />
  //   );
  // }
